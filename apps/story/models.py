...
class Event(BaseTimeStampModel):
    ...
    participants = models.ManyToManyField(
        Character, verbose_name=_("Uczestnicy wydarzeń"), blank=True
    )
    story = models.ForeignKey(
        Story, verbose_name=_("Historia"), on_delete=models.PROTECT
    )
    ...
    included_in_event = models.ManyToManyField(
        "self", verbose_name=_("Zawarte w wydarzeniu"), blank=True
    )
